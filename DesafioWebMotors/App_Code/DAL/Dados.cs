...
public class Dados
{
    ...
    {
        //SqlConnection connection = new SqlConnection("Data Source=bssp-44;Initial Catalog=AdventureWorks2012;Persist Security Info=True;User ID=admdelphi;Password=xxxxxx");
